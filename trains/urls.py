...
from trains.views import TrainsViews, RouteViews, StationViews,Train_StatusViews, RouteStation 
...
urlpatterns = [
    ...
    path('route-station/', RouteStation.as_view({'get': 'list'}), name= 'route-station'),
]
